...
controls = dbc.FormGroup(
    [
        ...
        dbc.Card([dbc.Checklist(
            id='check_list',
            options=[{
                'label': 'Share price x velocity',
                'value': 'value1'
            },
                {
                    'label': 'Volume x velocity',
                    'value': 'value2'
                },
                {
                    'label': 'Price*Volume x velocity',
                    'value': 'value3'
                }
            ],
            value=['value1', 'value2'],
    ...
    dbc.Col(
        dbc.Card(
            [
                ...
                dbc.CardBody(
                    [
                        html.H4('Analytic insights', className='card-title', style=CARD_TEXT_STYLE),
                        html.P('Loading...', style=CARD_TEXT_STYLE),
                    ]
                ),
            ]
...
def update_graph_5(n_clicks, dropdown_value, range_slider_value, check_list_value, radio_items_value):
    ...
    df = px.data.iris()
    fig = px.scatter(df, x='sepal_length', y='sepal_width', labels={"sepal_length":"time", "sepal_width":"sentiment"}, title="Sentiment graph")
    return fig

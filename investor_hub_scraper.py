...
def investors_hub_scraper(url,ticker):
    ...
    while url is not None and counter != 0 and counter != 1:
        ...
        if response.status_code == 200:
            ...
            for comment in comments:
                ...
                comment_info.append([user,datetime_object,text,int(reply_number)*2 + ecount,"investorshub.com", ticker])
...
investors_hub_scraper("https://investorshub.advfn.com/Nio-Inc-NIO-36185", "NIO")
